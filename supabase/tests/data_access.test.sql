...
select is(
  ...
  array[
    ...
    'owner_public_profiles:INSERT',
    'owner_public_profiles:SELECT',
    'owner_public_profiles:UPDATE',
    'pack_cards:SELECT',
    'pack_plays:INSERT',
    'pack_plays:SELECT',
    'pack_plays:UPDATE',
...
select is(
  ...
  array[
    ...
    'create_claimed_share_link(uuid,bytea,uuid,text,bytea,text,timestamp with time zone)',
    ...
    'disable_authenticated_share_link(uuid,uuid,uuid)',
    'disable_share_link(uuid,bytea,uuid)',
    'get_authenticated_owner_play_pack(uuid,uuid)',
    'get_authenticated_owner_play(uuid,uuid)',
    'get_authenticated_owner_profile(uuid,uuid)',
    'get_authenticated_owner_public_profile(uuid)',
    'get_authenticated_private_1to1_comparison(uuid,uuid,uuid)',
    'get_invite_metadata(text,bytea)',
    'get_invite_preview(text)',
    'get_owner_claim_state(uuid,bytea)',
    'get_owner_play_pack(uuid,bytea)',
    'get_owner_play(uuid,bytea)',
    'get_owner_profile(uuid,bytea)',
    'get_private_1to1_comparison(uuid,bytea,uuid)',
    'get_published_pack(text)',
    'get_visitor_response_pack_metadata(uuid,bytea)',
    'get_visitor_response(uuid,bytea)',
    'list_authenticated_owner_1to1_responses(uuid,uuid)',
    'list_authenticated_owner_plays(uuid)',
    'list_authenticated_share_links(uuid,uuid)',
    ...
    'set_authenticated_owner_nickname(uuid,text)',
