...
from (
  values (
    'bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid,
    '630c20b9-460b-443b-b74b-865d1dfdf5fb'::uuid,
    'after-work-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid, 'clock-out', 1, '할 일을 마친 직후 나는?', '할 일을 마친 직후 이 사람은?', '바로 다음 즐거움으로 전환한다', '잠깐 멍하니 속도를 늦춘다', true),
    ('bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid, 'route-home', 2, '집에 가는 길 나는?', '집에 가는 길 이 사람은?', '지름길로 빨리 간다', '기분 전환할 길을 고른다', false),
    ('bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid, 'dinner', 3, '저녁을 고를 때 나는?', '저녁을 고를 때 이 사람은?', '간단하게 바로 해결한다', '먹고 싶은 걸 찾아 챙긴다', false),
    ('bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid, 'decompress', 4, '하루를 정리하는 방식은?', '이 사람이 하루를 정리하는 방식은?', '누군가와 이야기하며 푼다', '혼자 좋아하는 걸 하며 푼다', false),
    ('bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid, 'message-after', 5, '퇴근 후 연락이 오면 나는?', '퇴근 후 연락이 오면 이 사람은?', '가볍게 바로 답한다', '내 시간 뒤에 답한다', false),
    ('bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid, 'energy', 6, '저녁 에너지가 남아 있으면 나는?', '저녁 에너지가 남아 있으면 이 사람은?', '밖에서 한 가지 더 한다', '내일을 위해 아껴 둔다', false),
    ('bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid, 'weeknight', 7, '평일 저녁 약속이 생기면 나는?', '평일 저녁 약속이 생기면 이 사람은?', '퇴근길에 바로 합류한다', '다른 날로 천천히 잡는다', false),
    ('bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid, 'hobby', 8, '퇴근 후 취미를 할 때 나는?', '퇴근 후 취미를 할 때 이 사람은?', '정해 둔 루틴을 따른다', '그날 끌리는 걸 고른다', false),
    ('bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid, 'tomorrow', 9, '집에 들어온 직후 나는?', '집에 들어온 직후 이 사람은?', '씻고 완전히 전환한다', '잠깐 쉬며 천천히 전환한다', false),
    ('bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid, 'weekend-countdown', 10, '주말을 기다리는 방식은?', '이 사람이 주말을 기다리는 방식은?', '하고 싶은 계획을 세운다', '그날까지 지금에 집중한다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'bc540a1f-611f-4664-b4c7-094fa67f73c0'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('bc540a1f-611f-4664-b4c7-094fa67f73c0')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'bc540a1f-611f-4664-b4c7-094fa67f73c0'
...
from (
  values (
    '550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid,
    'f16e20a8-f2bd-4799-af68-689bbc36ebd5'::uuid,
    'algorithm-mirror-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid, 'feed-clue', 1, '내 피드가 나를 너무 잘 안다고 느끼면 나는?', '추천 피드가 취향을 너무 잘 안다고 느껴지면 이 사람은?', '추천을 더 깊게 따라간다', '일부러 다른 걸 찾아본다', true),
    ('550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid, 'save-first', 2, '누가 콘텐츠를 추천해 주면 나는?', '누가 콘텐츠를 추천해 주면 이 사람은?', '바로 열어 본다', '저장해 두고 나중에 본다', false),
    ('550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid, 'rabbit-hole', 3, '하나를 보다가 다른 주제로 새면 나는?', '하나를 보다가 다른 주제로 새면 이 사람은?', '끝까지 새 길을 탐험한다', '원래 보려던 곳으로 돌아온다', false),
    ('550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid, 'share-find', 4, '내 취향 저격 콘텐츠를 보면 나는?', '취향에 딱 맞는 콘텐츠를 보면 이 사람은?', '누군가에게 바로 보낸다', '혼자 여러 번 다시 본다', false),
    ('550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid, 'trend-check', 5, '다들 하는 유행을 보면 나는?', '다들 하는 유행을 보면 이 사람은?', '왜 뜨는지 한 번 해본다', '나한테 맞는지부터 본다', false),
    ('550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid, 'recommendation', 6, '추천을 받을 때 나는?', '추천을 받을 때 이 사람은?', '비슷한 걸 더 찾아본다', '정반대도 같이 비교한다', false),
    ('550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid, 'comment-dive', 7, '흥미로운 영상 아래에서 나는?', '흥미로운 영상 아래에서 이 사람은?', '댓글 반응까지 읽는다', '영상만 보고 다음으로 간다', false),
    ('550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid, 'old-favorite', 8, '예전에 좋아한 걸 다시 발견하면 나는?', '예전에 좋아한 걸 다시 발견하면 이 사람은?', '그때 기록을 다시 찾아본다', '지금의 취향과 비교한다', false),
    ('550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid, 'search-style', 9, '궁금한 게 생기면 나는?', '궁금한 게 생기면 이 사람은?', '검색어를 구체적으로 만든다', '대충 넣고 흐름을 따라간다', false),
    ('550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid, 'recommend-to-me', 10, '누가 취향을 추천해 달라 하면 나는?', '누가 취향을 추천해 달라 하면 이 사람은?', '내 최애 하나를 강하게 민다', '상대 취향부터 물어본다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '550e9a66-9a65-4704-b15a-b6be3f6af644'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('550e9a66-9a65-4704-b15a-b6be3f6af644')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '550e9a66-9a65-4704-b15a-b6be3f6af644'
...
from (
  values (
    '49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid,
    '75ccfdf6-bf0d-4fb8-b8a4-a8cb5f933701'::uuid,
    'camera-roll-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid, 'first-photo', 1, '재밌는 순간이 오면 나는?', '재밌는 순간이 오면 이 사람은?', '바로 사진부터 남긴다', '먼저 그 순간을 즐긴다', true),
    ('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid, 'food-photo', 2, '맛있는 음식 앞에서 나는?', '맛있는 음식 앞에서 이 사람은?', '예쁘게 찍고 먹는다', '따뜻할 때 먼저 먹는다', false),
    ('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid, 'selfie', 3, '내 사진을 찍을 때 나는?', '자기 사진을 찍을 때 이 사람은?', '여러 장 중 마음에 드는 걸 고른다', '한 장의 자연스러운 컷을 남긴다', false),
    ('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid, 'friend-photo', 4, '친구 사진을 찍어 줄 때 나는?', '친구 사진을 찍어 줄 때 이 사람은?', '각도와 구도를 신경 쓴다', '재밌는 표정을 먼저 끌어낸다', false),
    ('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid, 'cleanup', 5, '사진이 쌓이면 나는?', '사진이 쌓이면 이 사람은?', '틈틈이 정리한다', '필요할 때 찾아본다', false),
    ('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid, 'old-album', 6, '예전 사진을 보면 나는?', '예전 사진을 보면 이 사람은?', '그날 이야기를 떠올린다', '그때의 분위기를 다시 느낀다', false),
    ('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid, 'share-photo', 7, '함께 찍은 사진을 고를 때 나는?', '함께 찍은 사진을 고를 때 이 사람은?', '바로 보내서 같이 본다', '마음에 드는 걸 골라 보낸다', false),
    ('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid, 'screenshot', 8, '스크린샷을 찍는 이유는 주로?', '이 사람이 스크린샷을 찍는 이유는 주로?', '나중에 다시 보려고', '누군가에게 보여 주려고', false),
    ('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid, 'landscape', 9, '풍경 앞에서 나는?', '풍경 앞에서 이 사람은?', '멋진 화면을 만들고 싶다', '눈으로 오래 기억하고 싶다', false),
    ('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid, 'favorite', 10, '좋아하는 사진 한 장을 고를 때 나는?', '좋아하는 사진 한 장을 고를 때 이 사람은?', '표정이 선명한 사진을 고른다', '장면이 넓게 담긴 사진을 고른다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'
...
from (
  values (
    'bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid,
    '0a9b7ee3-9556-448f-8719-329094601b1a'::uuid,
    'comment-section-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid, 'surprise-thought', 1, '뜻밖의 일이 생기면 내 머릿속은?', '뜻밖의 일이 생기면 이 사람 머릿속은?', '말로 바로 나오는 편이다', '속으로 먼저 여러 번 생각한다', true),
    ('bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid, 'replay', 2, '대화가 끝난 뒤 머릿속 첫 반응은?', '대화가 끝난 뒤 이 사람 머릿속 첫 반응은?', '방금 한 말을 다시 재생한다', '다음에 할 말을 미리 붙인다', false),
    ('bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid, 'awkward-moment', 3, '민망한 순간이 오면 나는?', '민망한 순간이 오면 이 사람은?', '웃으며 바로 넘긴다', '혼자 조금 더 곱씹는다', false),
    ('bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid, 'idea', 4, '좋은 생각이 떠오르면 나는?', '좋은 생각이 떠오르면 이 사람은?', '누군가에게 말하며 키운다', '혼자 메모하며 다듬는다', false),
    ('bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid, 'choice-voice', 5, '결정을 내리기 직전 내적 댓글은?', '결정을 내리기 직전 이 사람의 내적 댓글은?', '이유 하나면 충분하다고 한다', '놓친 조건이 없나 다시 묻는다', false),
    ('bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid, 'quiet', 6, '조용한 시간에 나는?', '조용한 시간에 이 사람은?', '생각이 더 선명해진다', '생각도 함께 쉬어 간다', false),
    ('bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid, 'mistake', 7, '실수를 알아차리면 나는?', '실수를 알아차리면 이 사람은?', '바로 고칠 방법을 찾는다', '왜 그랬는지 먼저 이해한다', false),
    ('bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid, 'compliment-thought', 8, '좋은 말을 들은 뒤 나는?', '좋은 말을 들은 뒤 이 사람은?', '그 말이 오래 떠오른다', '그 자리에서 힘을 얻는다', false),
    ('bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid, 'plan-thought', 9, '새 계획 앞에서 머릿속 첫 반응은?', '새 계획 앞에서 이 사람 머릿속 첫 반응은?', '해볼 장면부터 떠올린다', '필요한 준비부터 떠올린다', false),
    ('bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid, 'share-thought', 10, '마음에 걸리는 생각이 있으면 나는?', '마음에 걸리는 생각이 있으면 이 사람은?', '믿는 사람에게 말해 본다', '시간을 두고 혼자 정리한다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'bc3586dc-e21d-463d-b0e8-8480318f86cf'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('bc3586dc-e21d-463d-b0e8-8480318f86cf')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'bc3586dc-e21d-463d-b0e8-8480318f86cf'
...
from (
  values (
    'ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid,
    'e517cc31-8a8c-4156-a2ae-7e8ddb3f6809'::uuid,
    'compliment-receipt-v2'
  )
) as seed (id, template_id, version)
where exists (
  select 1
...
from (
  values
    ('ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid, 'receive', 1, '칭찬을 들으면 나는?', '칭찬을 들으면 이 사람은?', '기분 좋은 티가 바로 난다', '쑥스러워도 조용히 기억한다', true),
    ('ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid, 'give', 2, '좋은 점을 발견하면 나는?', '좋은 점을 발견하면 이 사람은?', '그 자리에서 바로 말한다', '딱 맞는 순간까지 아껴 둔다', false),
    ('ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid, 'specific', 3, '누군가를 칭찬할 때 나는?', '이 사람이 누군가를 칭찬할 때는?', '구체적인 장면을 말한다', '느낀 마음을 크게 전한다', false),
    ('ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid, 'achievement', 4, '내가 잘했다는 말을 들으면 나는?', '자기가 잘했다는 말을 들으면 이 사람은?', '들인 과정을 먼저 이야기한다', '도와준 사람을 먼저 이야기한다', false),
    ('ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid, 'awkward', 5, '갑자기 다정한 말을 들으면 나는?', '갑자기 다정한 말을 들으면 이 사람은?', '장난으로 받아친다', '고맙다고 그대로 받는다', false),
    ('ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid, 'encourage', 6, '힘들어 보이는 사람에게 나는?', '힘들어 보이는 사람에게 이 사람은?', '실질적인 도움을 제안한다', '먼저 마음을 알아준다', false),
    ('ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid, 'small-win', 7, '작은 성공이 생기면 나는?', '작은 성공이 생기면 이 사람은?', '누군가에게 바로 알린다', '혼자 뿌듯해하며 쌓아 둔다', false),
    ('ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid, 'feedback', 8, '좋은 피드백을 받으면 나는?', '좋은 피드백을 받으면 이 사람은?', '다음에도 살리고 싶어진다', '왜 좋았는지 분석해 본다', false),
    ('ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid, 'support', 9, '친구가 스스로를 깎아내리면 나는?', '친구가 스스로를 깎아내리면 이 사람은?', '구체적으로 잘한 점을 말한다', '그 말이 나온 마음부터 묻는다', false),
    ('ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid, 'memory', 10, '오래 남는 말은 내게?', '이 사람에게 오래 남는 말은?', '나를 정확히 봐 준 말', '용기를 건네 준 말', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'ef9687d9-12ce-48cb-a130-d7ef63d2e17f'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('ef9687d9-12ce-48cb-a130-d7ef63d2e17f')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'ef9687d9-12ce-48cb-a130-d7ef63d2e17f'
...
from (
  values (
    'e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid,
    'dec475db-00a1-43ea-91c5-75d32259fd6b'::uuid,
    'decision-spiral-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid, 'menu', 1, '고를 게 너무 많을 때 나는?', '고를 게 너무 많을 때 이 사람은?', '기준을 하나 정해 빠르게 고른다', '후회 없게 끝까지 비교한다', true),
    ('e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid, 'recommendation', 2, '사소한 선택도 귀찮은 날 나는?', '사소한 선택도 귀찮은 날 이 사람은?', '익숙한 답을 바로 고른다', '결정을 다음으로 미룬다', false),
    ('e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid, 'big-choice', 3, '결정할 시간이 넉넉하면 나는?', '결정할 시간이 넉넉하면 이 사람은?', '일찍 정해 마음을 비운다', '마지막까지 가능성을 열어 둔다', false),
    ('e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid, 'coin-flip', 4, '둘 중 하나를 못 고르면 나는?', '둘 중 하나를 못 고르면 이 사람은?', '마감 시간을 정해 고른다', '하루 더 두고 본다', false),
    ('e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid, 'risk', 5, '새로운 선택 앞에서 나는?', '새로운 선택 앞에서 이 사람은?', '해보면서 배우는 쪽을 고른다', '안전한 기준점을 먼저 찾는다', false),
    ('e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid, 'purchase', 6, '사고 싶은 게 생기면 나는?', '사고 싶은 게 생기면 이 사람은?', '필요한 이유를 적어 본다', '며칠 뒤에도 생각나는지 본다', false),
    ('e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid, 'plan-change', 7, '정한 계획을 바꿀 때 나는?', '정한 계획을 바꿀 때 이 사람은?', '더 나은 이유가 있으면 바꾼다', '처음 정한 약속을 지킨다', false),
    ('e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid, 'advice', 8, '누가 선택을 물어보면 나는?', '누가 선택을 물어보면 이 사람은?', '내가 고를 답을 말해 준다', '상대 기준을 같이 정리한다', false),
    ('e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid, 'regret', 9, '선택 뒤 아쉬움이 남으면 나는?', '선택 뒤 아쉬움이 남으면 이 사람은?', '다음 선택의 기준으로 쓴다', '좋았던 점을 먼저 찾는다', false),
    ('e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid, 'easy-day', 10, '결정 피로가 쌓인 날 나는?', '결정 피로가 쌓인 날 이 사람은?', '누군가가 정해 주면 편하다', '아무것도 정하지 않고 싶다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'e0c86bc5-363f-4efa-95e9-1a5672ec3e83'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('e0c86bc5-363f-4efa-95e9-1a5672ec3e83')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'e0c86bc5-363f-4efa-95e9-1a5672ec3e83'
...
from (
  values (
    'ce1ce7fe-c839-4d28-8648-462680b96103'::uuid,
    '4c3f9b04-48a2-4dda-a2f9-bfcc101a9565'::uuid,
    'emoji-subtitles-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('ce1ce7fe-c839-4d28-8648-462680b96103'::uuid, 'reaction-style', 1, '말보다 반응이 먼저 나올 때 나는?', '말보다 반응이 먼저 나올 때 이 사람은?', '이모지나 짤로 답한다', '짧은 문장으로 바로 말한다', true),
    ('ce1ce7fe-c839-4d28-8648-462680b96103'::uuid, 'funny-post', 2, '웃긴 걸 발견하면 나는?', '웃긴 걸 발견하면 이 사람은?', '딱 생각나는 사람에게 보낸다', '내 저장 목록에 넣어 둔다', false),
    ('ce1ce7fe-c839-4d28-8648-462680b96103'::uuid, 'tone', 3, '장난을 칠 때 나는?', '장난을 칠 때 이 사람은?', '표정이나 이모지를 덧붙인다', '말투만으로 전달한다', false),
    ('ce1ce7fe-c839-4d28-8648-462680b96103'::uuid, 'inside-reference', 4, '상대가 낯선 표현을 쓰면 나는?', '상대가 낯선 표현을 쓰면 이 사람은?', '뜻을 물어보고 따라 써 본다', '맥락을 보며 천천히 익힌다', false),
    ('ce1ce7fe-c839-4d28-8648-462680b96103'::uuid, 'misread', 5, '장난이 오해될 것 같으면 나는?', '장난이 오해될 것 같으면 이 사람은?', '표정 이모지를 하나 붙인다', '짧게 진심을 덧붙인다', false),
    ('ce1ce7fe-c839-4d28-8648-462680b96103'::uuid, 'gif-choice', 6, '반응 하나를 고를 때 나는?', '반응 하나를 고를 때 이 사람은?', '정확하게 맞는 걸 찾는다', '가장 빠르게 떠오른 걸 보낸다', false),
    ('ce1ce7fe-c839-4d28-8648-462680b96103'::uuid, 'new-slang', 7, '새로운 말투를 들으면 나는?', '새로운 말투를 들으면 이 사람은?', '재밌으면 바로 써 본다', '어울릴 때까지 지켜본다', false),
    ('ce1ce7fe-c839-4d28-8648-462680b96103'::uuid, 'laughter', 8, '텍스트로 웃음을 표현할 때 나는?', '텍스트로 웃음을 표현할 때 이 사람은?', '크고 분명하게 반응한다', '조용히 한 마디를 남긴다', false),
    ('ce1ce7fe-c839-4d28-8648-462680b96103'::uuid, 'reply-context', 9, '이모지 하나로 답하기 어려우면 나는?', '이모지 하나로 답하기 어려우면 이 사람은?', '여러 개를 조합해 보낸다', '짧은 문장으로 바꿔 보낸다', false),
    ('ce1ce7fe-c839-4d28-8648-462680b96103'::uuid, 'translate', 10, '상대가 내 반응을 못 알아들으면 나는?', '상대가 반응을 못 알아들으면 이 사람은?', '더 익숙한 이모지로 바꾼다', '말로 뜻을 풀어 준다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'ce1ce7fe-c839-4d28-8648-462680b96103'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('ce1ce7fe-c839-4d28-8648-462680b96103')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'ce1ce7fe-c839-4d28-8648-462680b96103'
...
from (
  values (
    'e53a15e2-f710-4945-aa12-839e8ecda934'::uuid,
    '12121212-1212-4212-8212-121212121212'::uuid,
    'first-impression-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('e53a15e2-f710-4945-aa12-839e8ecda934'::uuid, 'first-move', 1, '처음 만난 자리에서 나는?', '처음 만난 자리에서 이 사람은?', '먼저 말을 건다', '상대가 말을 걸면 자연스럽게 이어 간다', true),
    ('e53a15e2-f710-4945-aa12-839e8ecda934'::uuid, 'first-topic', 2, '처음 대화를 시작할 때 나는?', '처음 대화를 시작할 때 이 사람은?', '공통점을 먼저 찾는다', '지금 상황에서 소재를 찾는다', false),
    ('e53a15e2-f710-4945-aa12-839e8ecda934'::uuid, 'group-entry', 3, '낯선 사람들이 모인 자리에 가면 나는?', '낯선 사람들이 모인 자리에 가면 이 사람은?', '여러 사람에게 두루 인사한다', '한두 사람과 먼저 친해진다', false),
    ('e53a15e2-f710-4945-aa12-839e8ecda934'::uuid, 'silence', 4, '대화가 잠시 끊기면 나는?', '대화가 잠시 끊기면 이 사람은?', '새 화제를 꺼낸다', '잠깐의 침묵도 편하게 둔다', false),
    ('e53a15e2-f710-4945-aa12-839e8ecda934'::uuid, 'interest', 5, '상대 이야기에 관심을 보일 때 나는 주로?', '상대 이야기에 관심을 보일 때 이 사람은 주로?', '표정과 맞장구로 보여 준다', '이어지는 질문으로 보여 준다', false),
    ('e53a15e2-f710-4945-aa12-839e8ecda934'::uuid, 'humor', 6, '첫 만남에서 웃음이 생기면 나는?', '첫 만남에서 웃음이 생기면 이 사람은?', '먼저 농담을 꺼낸다', '상대 농담에 크게 반응한다', false),
    ('e53a15e2-f710-4945-aa12-839e8ecda934'::uuid, 'warm-up', 7, '새로운 사람과 가까워질 때 나는?', '새로운 사람과 가까워질 때 이 사람은?', '짧은 시간에도 금방 편해진다', '몇 번 만나며 천천히 편해진다', false),
    ('e53a15e2-f710-4945-aa12-839e8ecda934'::uuid, 'meet-again', 8, '처음 만난 사람을 다시 만나면 나는 먼저?', '처음 만난 사람을 다시 만나면 이 사람은 먼저?', '전에 나눈 이야기를 꺼낸다', '새로운 근황을 묻는다', false),
    ('e53a15e2-f710-4945-aa12-839e8ecda934'::uuid, 'follow-up', 9, '처음 만난 뒤 연락할 때 나는?', '처음 만난 뒤 연락할 때 이 사람은?', '먼저 짧게 안부를 보낸다', '다음에 만날 계기가 생기면 연락한다', false),
    ('e53a15e2-f710-4945-aa12-839e8ecda934'::uuid, 'outfit', 10, '처음 만나는 날 옷을 고를 때 나는?', '처음 만나는 날 옷을 고를 때 이 사람은?', '눈에 띄는 포인트를 더한다', '익숙하고 편한 옷을 고른다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'e53a15e2-f710-4945-aa12-839e8ecda934'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('e53a15e2-f710-4945-aa12-839e8ecda934')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'e53a15e2-f710-4945-aa12-839e8ecda934'
...
from (
  values (
    '9afc9717-1059-4e02-89f4-5537d4703919'::uuid,
    '2cb89681-7c7b-42c4-b1f3-4700d5c17cc0'::uuid,
    'friend-fusion-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('9afc9717-1059-4e02-89f4-5537d4703919'::uuid, 'combined-plan', 1, '친구와 내가 한 팀이면 나는?', '친구와 한 팀이 되면 이 사람은?', '시작을 끌어가는 역할', '마무리를 챙기는 역할', true),
    ('9afc9717-1059-4e02-89f4-5537d4703919'::uuid, 'trip-team', 2, '여행을 같이 준비하면 나는?', '여행을 같이 준비하면 이 사람은?', '가고 싶은 곳을 모은다', '현실적인 동선을 만든다', false),
    ('9afc9717-1059-4e02-89f4-5537d4703919'::uuid, 'game-team', 3, '게임이나 놀이에서 나는?', '게임이나 놀이에서 이 사람은?', '규칙을 빨리 파악한다', '분위기를 더 재밌게 만든다', false),
    ('9afc9717-1059-4e02-89f4-5537d4703919'::uuid, 'food-team', 4, '메뉴를 같이 고르면 나는?', '메뉴를 같이 고르면 이 사람은?', '후보를 여러 개 던진다', '마지막 선택을 정리한다', false),
    ('9afc9717-1059-4e02-89f4-5537d4703919'::uuid, 'problem-team', 5, '갑작스러운 문제가 생기면 나는?', '갑작스러운 문제가 생기면 이 사람은?', '해결책부터 찾는다', '사람들 기분부터 살핀다', false),
    ('9afc9717-1059-4e02-89f4-5537d4703919'::uuid, 'photo-team', 6, '함께 사진을 찍으면 나는?', '함께 사진을 찍으면 이 사람은?', '구도를 잡는 쪽이다', '표정을 만드는 쪽이다', false),
    ('9afc9717-1059-4e02-89f4-5537d4703919'::uuid, 'gift-team', 7, '선물을 같이 고르면 나는?', '선물을 같이 고르면 이 사람은?', '상대 정보를 모은다', '결정적인 한 가지를 고른다', false),
    ('9afc9717-1059-4e02-89f4-5537d4703919'::uuid, 'story-team', 8, '둘만 아는 이야기가 생기면 나는?', '둘만 아는 이야기가 생기면 이 사람은?', '자세한 장면을 기억한다', '그때의 감정을 기억한다', false),
    ('9afc9717-1059-4e02-89f4-5537d4703919'::uuid, 'support-team', 9, '친구가 지치면 나는?', '친구가 지치면 이 사람은?', '필요한 일을 같이 한다', '옆에 있어 주며 듣는다', false),
    ('9afc9717-1059-4e02-89f4-5537d4703919'::uuid, 'best-combo', 10, '친구와 내가 잘 맞는 이유는?', '이 사람과 친구가 잘 맞는 이유는?', '비슷한 속도로 함께 움직여서', '서로 다른 빈틈을 채워 줘서', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '9afc9717-1059-4e02-89f4-5537d4703919'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('9afc9717-1059-4e02-89f4-5537d4703919')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '9afc9717-1059-4e02-89f4-5537d4703919'
...
from (
  values (
    '7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid,
    '0e2ac6eb-55f4-40f2-b943-6de54125f6b3'::uuid,
    'group-chat-role-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid, 'new-message', 1, '단체 채팅방에 새 소식이 올라오면 나는?', '단체 채팅방에 새 소식이 올라오면 이 사람은?', '바로 리액션을 남긴다', '내용을 다 읽고 한마디 한다', true),
    ('7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid, 'plan-maker', 2, '모임 얘기가 나오면 나는?', '모임 얘기가 나오면 이 사람은?', '날짜 후보를 먼저 던진다', '사람들 반응을 보고 고른다', false),
    ('7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid, 'photo-drop', 3, '사진이 한꺼번에 올라오면 나는?', '사진이 한꺼번에 올라오면 이 사람은?', '마음에 드는 한 장을 고른다', '그때 있었던 일을 다시 꺼낸다', false),
    ('7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid, 'silence-break', 4, '채팅방이 조용해지면 나는?', '채팅방이 조용해지면 이 사람은?', '새로운 소재를 올린다', '조용한 상태도 그냥 둔다', false),
    ('7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid, 'notification', 5, '알림이 많이 쌓이면 나는?', '알림이 많이 쌓이면 이 사람은?', '틈날 때 처음부터 읽는다', '중요한 부분부터 훑는다', false),
    ('7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid, 'birthday', 6, '누군가 생일인 걸 알면 나는?', '누군가 생일인 걸 알면 이 사람은?', '바로 축하 메시지를 보낸다', '센스 있는 사진이나 말을 찾는다', false),
    ('7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid, 'decision', 7, '의견이 갈리는 대화에서 나는?', '의견이 갈리는 대화에서 이 사람은?', '내 선택과 이유를 말한다', '공통으로 괜찮은 안을 찾는다', false),
    ('7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid, 'inside-joke', 8, '우리끼리만 아는 얘기가 나오면 나는?', '우리끼리만 아는 얘기가 나오면 이 사람은?', '더 살을 붙여 웃긴다', '그때 장면을 정확히 복기한다', false),
    ('7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid, 'exit', 9, '대화가 너무 빨라지면 나는?', '대화가 너무 빨라지면 이 사람은?', '흐름에 맞춰 짧게 낀다', '나중에 읽고 필요한 말만 한다', false),
    ('7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid, 'meeting-day', 10, '모임 당일 나는?', '모임 당일 이 사람은?', '일찍부터 분위기를 띄운다', '도착해서 자연스럽게 합류한다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '7063c80f-59c4-4f93-8446-205dd8b418bd'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('7063c80f-59c4-4f93-8446-205dd8b418bd')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '7063c80f-59c4-4f93-8446-205dd8b418bd'
...
from (
  values (
    '9578a970-252f-4eec-a3bf-12f211a56259'::uuid,
    '14141414-1414-4414-8414-141414141414'::uuid,
    'honest-self-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('9578a970-252f-4eec-a3bf-12f211a56259'::uuid, 'busy-mind', 1, '마음이 복잡한 날 나는?', '마음이 복잡한 날 이 사람은?', '누군가에게 말하며 정리한다', '혼자 시간을 보내며 정리한다', true),
    ('9578a970-252f-4eec-a3bf-12f211a56259'::uuid, 'compliment', 2, '기분이 안 좋은데 괜찮다고 말할 때 나는?', '기분이 안 좋은데 괜찮다고 말할 때 이 사람은?', '평소보다 말수가 줄어든다', '평소처럼 행동하려 한다', false),
    ('9578a970-252f-4eec-a3bf-12f211a56259'::uuid, 'big-choice', 3, '신경 쓰이는 일이 있으면 나는?', '신경 쓰이는 일이 있으면 이 사람은?', '같은 이야기를 여러 번 꺼낸다', '다른 일에 더 몰두한다', false),
    ('9578a970-252f-4eec-a3bf-12f211a56259'::uuid, 'letdown', 4, '기대했던 일이 어긋난 직후 나는?', '기대했던 일이 어긋난 직후 이 사람은?', '아쉬움을 말로 표현한다', '다음 방법부터 찾는다', false),
    ('9578a970-252f-4eec-a3bf-12f211a56259'::uuid, 'misunderstood', 5, '오해받았다고 느끼면 나는?', '오해받았다고 느끼면 이 사람은?', '그 자리에서 바로 풀려고 한다', '감정이 가라앉은 뒤 이야기한다', false),
    ('9578a970-252f-4eec-a3bf-12f211a56259'::uuid, 'free-day', 6, '편한 사람과 단둘이 있으면 나는?', '편한 사람과 단둘이 있으면 이 사람은?', '사소한 이야기까지 많이 한다', '말없이 있어도 편하게 쉰다', false),
    ('9578a970-252f-4eec-a3bf-12f211a56259'::uuid, 'need-help', 7, '도움이 필요할 때 나는?', '도움이 필요할 때 이 사람은?', '구체적으로 부탁한다', '혼자 해본 뒤 부탁한다', false),
    ('9578a970-252f-4eec-a3bf-12f211a56259'::uuid, 'new-start', 8, '걱정이 많아진 날 나는?', '걱정이 많아진 날 이 사람은?', '사소한 걸 자주 확인한다', '혼자 정리하는 시간이 길어진다', false),
    ('9578a970-252f-4eec-a3bf-12f211a56259'::uuid, 'attention', 9, '사람들이 나를 주목하면 나는?', '사람들이 이 사람을 주목하면?', '그 분위기를 즐기는 편이다', '조금 뒤로 물러나는 편이다', false),
    ('9578a970-252f-4eec-a3bf-12f211a56259'::uuid, 'affection', 10, '좋아하는 사람에게 마음을 표현할 때 나는 주로?', '좋아하는 사람에게 마음을 표현할 때 이 사람은?', '말로 직접 전한다', '행동으로 자연스럽게 보여 준다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '9578a970-252f-4eec-a3bf-12f211a56259'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('9578a970-252f-4eec-a3bf-12f211a56259')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '9578a970-252f-4eec-a3bf-12f211a56259'
...
from (
  values
    ('e05e6366-2a00-4798-8273-0af5f16aad10'::uuid, 'conflict', 1, '서운한 일이 생기면 나는?', '서운한 일이 생기면 이 사람은?', '바로 이야기한다', '생각을 정리한 뒤 말한다', false),
    ('e05e6366-2a00-4798-8273-0af5f16aad10'::uuid, 'reunion', 2, '오랜만에 친구를 만나면 나는?', '오랜만에 친구를 만나면 이 사람은?', '어제 본 듯 바로 편해진다', '근황부터 천천히 맞춰 간다', true),
    ('e05e6366-2a00-4798-8273-0af5f16aad10'::uuid, 'plans', 3, '약속을 잡을 때 나는?', '약속을 잡을 때 이 사람은?', '미리 날짜를 정한다', '그때그때 편한 날을 본다', false),
    ('e05e6366-2a00-4798-8273-0af5f16aad10'::uuid, 'comfort', 4, '친구가 고민을 털어놓으면 나는?', '친구가 고민을 털어놓으면 이 사람은?', '먼저 끝까지 들어준다', '해결 방법부터 같이 찾는다', false),
    ('e05e6366-2a00-4798-8273-0af5f16aad10'::uuid, 'gathering', 5, '여러 친구가 모인 자리에서 나는?', '여러 친구가 모인 자리에서 이 사람은?', '먼저 분위기를 띄운다', '익숙한 사람 곁에서 시작한다', false),
    ('e05e6366-2a00-4798-8273-0af5f16aad10'::uuid, 'reconnect', 6, '연락이 뜸해졌을 때 나는?', '연락이 뜸해졌을 때 이 사람은?', '짧게 안부부터 보낸다', '만날 약속부터 잡는다', false),
    ('e05e6366-2a00-4798-8273-0af5f16aad10'::uuid, 'memory', 7, '옛날 이야기가 나오면 나는?', '옛날 이야기가 나오면 이 사람은?', '구체적인 장면부터 떠올린다', '그때 느낀 감정부터 떠올린다', false),
    ('e05e6366-2a00-4798-8273-0af5f16aad10'::uuid, 'travel', 8, '친구와 여행 일정을 정할 때 나는?', '친구와 여행 일정을 정할 때 이 사람은?', '미리 계획을 세운다', '현장에서 그때그때 정한다', false),
    ('e05e6366-2a00-4798-8273-0af5f16aad10'::uuid, 'celebration', 9, '친구의 좋은 소식을 들으면 나는?', '친구의 좋은 소식을 들으면 이 사람은?', '바로 메시지로 마음을 전한다', '만났을 때 더 길게 축하한다', false),
    ('e05e6366-2a00-4798-8273-0af5f16aad10'::uuid, 'hard-day', 10, '힘든 날에 나는?', '힘든 날에 이 사람은?', '먼저 연락해 털어놓는다', '혼자 정리한 뒤 연락한다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'e05e6366-2a00-4798-8273-0af5f16aad10'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('e05e6366-2a00-4798-8273-0af5f16aad10')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'e05e6366-2a00-4798-8273-0af5f16aad10'
...
from (
  values (
    'fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid,
    '0fbddb18-d125-429e-ad8f-d6581a3af762'::uuid,
    'reply-temperature-v2'
  )
) as seed (id, template_id, version)
where exists (
  select 1
...
from (
  values
    ('fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid, 'reply-gap', 1, '메시지를 보낸 뒤 답이 늦으면 나는?', '메시지를 보낸 뒤 답이 늦으면 이 사람은?', '다른 일을 하며 기다린다', '필요하면 한 번 더 가볍게 묻는다', true),
    ('fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid, 'first-text', 2, '먼저 연락하고 싶을 때 나는?', '먼저 연락하고 싶을 때 이 사람은?', '짧은 안부부터 보낸다', '보낼 이유가 생길 때까지 기다린다', false),
    ('fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid, 'emoji-reply', 3, '할 말은 많은데 바쁠 때 나는?', '할 말은 많은데 바쁠 때 이 사람은?', '이모지로 먼저 신호를 남긴다', '여유 생긴 뒤 제대로 답한다', false),
    ('fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid, 'long-message', 4, '긴 메시지를 받으면 나는?', '긴 메시지를 받으면 이 사람은?', '읽으며 바로바로 답한다', '한 번 다 읽고 정리해 답한다', false),
    ('fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid, 'typo', 5, '오타를 발견하면 나는?', '오타를 발견하면 이 사람은?', '바로 수정해서 다시 보낸다', '뜻이 통하면 그냥 둔다', false),
    ('fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid, 'late-night', 6, '늦은 밤 연락이 오면 나는?', '늦은 밤 연락이 오면 이 사람은?', '지금 할 수 있는 만큼 답한다', '다음 날 정신 있을 때 답한다', false),
    ('fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid, 'reaction', 7, '재밌는 걸 발견하면 나는?', '재밌는 걸 발견하면 이 사람은?', '바로 공유한다', '나중에 모아서 보낸다', false),
    ('fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid, 'voice-note', 8, '텍스트로 설명이 길어질 것 같으면 나는?', '텍스트로 설명이 길어질 것 같으면 이 사람은?', '음성이나 통화로 바꾼다', '글로 차근차근 적는다', false),
    ('fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid, 'read-receipt', 9, '읽음 표시를 본 뒤 나는?', '읽음 표시를 본 뒤 이 사람은?', '상대 상황을 생각하며 기다린다', '답이 필요한 때를 다시 알려 준다', false),
    ('fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid, 'goodbye', 10, '대화를 마칠 때 나는?', '대화를 마칠 때 이 사람은?', '다음 이야기를 남겨 둔다', '깔끔하게 인사하고 끝낸다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'fee031f8-b347-4f79-a5c7-9d35d8c8804f'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('fee031f8-b347-4f79-a5c7-9d35d8c8804f')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'fee031f8-b347-4f79-a5c7-9d35d8c8804f'
...
from (
  values (
    'aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid,
    'a714df85-063e-44f5-a3e5-cc4d6af032bc'::uuid,
    'room-temperature-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid, 'reset-space', 1, '집에 돌아와 가장 먼저 하는 건?', '이 사람이 집에 돌아와 가장 먼저 하는 건?', '공간을 편하게 바꾼다', '내 몸부터 쉬게 한다', true),
    ('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid, 'lighting', 2, '밤에 더 편한 빛은?', '이 사람이 밤에 더 편해하는 빛은?', '환하고 또렷한 빛', '은은하고 따뜻한 빛', false),
    ('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid, 'sound', 3, '집에서 나는?', '집에서 이 사람은?', '무언가 틀어 두는 편이다', '조용한 편이 좋다', false),
    ('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid, 'tidy', 4, '정리가 필요해 보이면 나는?', '정리가 필요해 보이면 이 사람은?', '바로 눈에 보이는 곳부터 한다', '각 잡고 한 번에 한다', false),
    ('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid, 'blanket', 5, '집에서 쉬기 시작할 때 나는?', '집에서 쉬기 시작할 때 이 사람은?', '편한 옷으로 완전히 갈아입는다', '지금 차림 그대로 편하게 앉는다', false),
    ('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid, 'window', 6, '방이 조금 답답하면 나는?', '방이 조금 답답하면 이 사람은?', '창문을 열어 공기를 바꾼다', '온도부터 맞춰 편하게 만든다', false),
    ('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid, 'plant', 7, '방에 하나를 더 들인다면 나는?', '방에 하나를 더 들인다면 이 사람은?', '보기 좋은 장식', '매일 쓰는 편한 물건', false),
    ('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid, 'desk', 8, '책상 위가 복잡해지면 나는?', '책상 위가 복잡해지면 이 사람은?', '정리해야 집중된다', '익숙한 어수선함도 괜찮다', false),
    ('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid, 'scent', 9, '공간 분위기를 바꾸고 싶을 때 나는?', '공간 분위기를 바꾸고 싶을 때 이 사람은?', '향이나 음악을 바꾼다', '가구나 배치를 바꾼다', false),
    ('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid, 'guest', 10, '집에 손님이 온다면 나는?', '집에 손님이 온다면 이 사람은?', '먹을 것부터 챙긴다', '편히 있을 자리를 만든다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'
...
from (
  values (
    'a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid,
    '547524ff-9929-44ef-b6d0-70b152b2f1e2'::uuid,
    'small-luxury-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid, 'treat', 1, '나를 기분 좋게 하는 작은 소비는?', '이 사람을 기분 좋게 하는 작은 소비는?', '평소보다 좋은 한 가지를 고른다', '여러 개의 작은 즐거움을 고른다', true),
    ('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid, 'coffee', 2, '카페에서 나는?', '카페에서 이 사람은?', '늘 좋아하는 메뉴를 고른다', '계절 메뉴를 한 번 시도한다', false),
    ('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid, 'gift', 3, '나에게 선물한다면 나는?', '자기에게 선물한다면 이 사람은?', '오래 쓸 물건을 고른다', '그날 바로 즐길 것을 고른다', false),
    ('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid, 'upgrade', 4, '더 좋은 선택지가 보이면 나는?', '더 좋은 선택지가 보이면 이 사람은?', '값어치를 따져 업그레이드한다', '기본으로도 충분한지 본다', false),
    ('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid, 'comfort', 5, '집에서 편해지려면 나는?', '집에서 편해지려면 이 사람은?', '촉감 좋은 것을 바꾼다', '공간 분위기를 바꾼다', false),
    ('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid, 'meal', 6, '혼자 맛있는 걸 먹을 때 나는?', '혼자 맛있는 걸 먹을 때 이 사람은?', '제대로 차려서 먹는다', '편한 방식으로 즐긴다', false),
    ('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid, 'collect', 7, '마음에 드는 물건을 발견하면 나는?', '마음에 드는 물건을 발견하면 이 사람은?', '비슷한 걸 모으고 싶어진다', '하나만 골라 오래 쓴다', false),
    ('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid, 'occasion', 8, '특별한 날이 아니어도 나는?', '특별한 날이 아니어도 이 사람은?', '작은 이유를 만들어 챙긴다', '다음 특별한 날을 위해 남겨 둔다', false),
    ('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid, 'recommend', 9, '좋은 걸 발견하면 나는?', '좋은 걸 발견하면 이 사람은?', '누구에게든 추천하고 싶다', '나만의 목록에 넣어 둔다', false),
    ('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid, 'memory', 10, '돈을 쓸 때 더 오래 남는 건?', '이 사람에게 더 오래 남는 건?', '물건을 쓰는 시간', '그때 만든 경험', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('a3b94c66-90c7-451b-b4ff-1bd14d7b27bd')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'
...
from (
  values (
    '4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid,
    '79c2f482-e254-41a5-9e27-296bf416a5d7'::uuid,
    'snack-personality-v2'
  )
) as seed (id, template_id, version)
where exists (
  select 1
...
from (
  values
    ('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid, 'snack-moment', 1, '간식이 당길 때 나는?', '간식이 당길 때 이 사람은?', '정해 둔 최애를 찾는다', '그날 당기는 맛을 고른다', true),
    ('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid, 'sweet-salty', 2, '더 먼저 손이 가는 쪽은?', '이 사람에게 더 먼저 손이 가는 쪽은?', '달콤한 한 입', '짭짤한 한 입', false),
    ('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid, 'share', 3, '간식을 나눌 때 나는?', '간식을 나눌 때 이 사람은?', '내가 좋아하는 걸 권한다', '상대 취향을 먼저 묻는다', false),
    ('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid, 'movie-snack', 4, '영상을 보며 먹을 간식을 고를 때 나는?', '영상을 보며 먹을 간식을 고를 때 이 사람은?', '손에 덜 묻는 걸 고른다', '먹는 재미가 있는 걸 고른다', false),
    ('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid, 'new-flavor', 5, '처음 보는 맛을 만나면 나는?', '처음 보는 맛을 만나면 이 사람은?', '궁금해서 시도한다', '후기를 보고 결정한다', false),
    ('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid, 'last-bite', 6, '마지막 한 입이 남으면 나는?', '마지막 한 입이 남으면 이 사람은?', '지금 먹어 깔끔하게 끝낸다', '나중을 위해 남겨 둔다', false),
    ('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid, 'stock', 7, '집에 간식을 둘 때 나는?', '집에 간식을 둘 때 이 사람은?', '없으면 불안한 걸 쟁인다', '그때그때 필요한 만큼 산다', false),
    ('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid, 'pairing', 8, '음료와 간식을 고를 때 나는?', '음료와 간식을 고를 때 이 사람은?', '잘 어울리는 조합을 맞춘다', '각자 먹고 싶은 걸 고른다', false),
    ('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid, 'craving', 9, '먹고 싶은 게 있는데 없으면 나는?', '먹고 싶은 게 있는데 없으면 이 사람은?', '비슷한 걸 찾아 해결한다', '다음 기회까지 기다린다', false),
    ('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid, 'gift-snack', 10, '누군가에게 간식을 고른다면 나는?', '누군가에게 간식을 고른다면 이 사람은?', '안전하게 좋아할 만한 걸 고른다', '새롭게 좋아할 걸 골라 본다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('4a144f35-1f7b-4cb5-a646-7a784c9cd4c3')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'
...
from (
  values (
    '403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid,
    'b5a4e134-2704-40b6-8fa3-7ad47c13e833'::uuid,
    'social-battery-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid, 'recharge', 1, '사람들과 오래 보낸 뒤 나는?', '사람들과 오래 보낸 뒤 이 사람은?', '누군가와 더 이야기하며 마무리한다', '혼자 조용히 있어야 회복된다', true),
    ('403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid, 'party-entry', 2, '모임에 도착하면 나는?', '모임에 도착하면 이 사람은?', '여러 사람에게 먼저 인사한다', '익숙한 사람부터 찾는다', false),
    ('403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid, 'new-person', 3, '처음 보는 사람이 있으면 나는?', '처음 보는 사람이 있으면 이 사람은?', '궁금한 걸 먼저 묻는다', '대화 흐름을 보며 합류한다', false),
    ('403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid, 'small-talk', 4, '아는 사람이 적은 모임에서 나는?', '아는 사람이 적은 모임에서 이 사람은?', '소개받으며 자리를 넓힌다', '한 사람과 대화를 오래 잇는다', false),
    ('403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid, 'week-plan', 5, '약속이 연달아 잡히면 나는?', '약속이 연달아 잡히면 이 사람은?', '재밌을 것 같아 기대한다', '중간에 비는 시간을 만든다', false),
    ('403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid, 'one-on-one', 6, '사람 많은 자리에서 더 지치는 순간은?', '사람 많은 자리에서 이 사람은 언제 더 지칠까?', '새 화제를 계속 찾아야 할 때', '여러 대화를 동시에 따라갈 때', false),
    ('403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid, 'after-cancel', 7, '모임에서 맡기 편한 역할은?', '모임에서 이 사람에게 편한 역할은?', '사람들을 자연스럽게 이어 주기', '필요한 걸 조용히 챙기기', false),
    ('403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid, 'hosting', 8, '사람들을 초대하는 날 나는?', '사람들을 초대하는 날 이 사람은?', '각자 편하게 놀게 만든다', '함께할 흐름을 준비한다', false),
    ('403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid, 'leave-time', 9, '모임을 마칠 때 나는?', '모임을 마칠 때 이 사람은?', '마지막까지 남아 이야기한다', '좋았을 때 먼저 인사한다', false),
    ('403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid, 'reset', 10, '사람 많은 날 집에 돌아오면 나는?', '사람 많은 날 집에 돌아오면 이 사람은?', '가볍게 움직이며 기분을 바꾼다', '불빛과 소리를 줄여 쉰다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '403e0aaa-ece5-4c92-88a9-cbe055a819f4'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('403e0aaa-ece5-4c92-88a9-cbe055a819f4')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '403e0aaa-ece5-4c92-88a9-cbe055a819f4'
...
from (
  values (
    '7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid,
    '78b2ca60-1f42-4114-a6e0-22155c2d701c'::uuid,
    'spontaneous-plan-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid, 'sudden-invite', 1, '지금 보자는 연락이 오면 나는?', '지금 보자는 연락이 오면 이 사람은?', '가능하면 바로 움직인다', '준비할 시간을 먼저 본다', true),
    ('7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid, 'meeting-place', 2, '약속 장소를 정할 때 나는?', '약속 장소를 정할 때 이 사람은?', '딱 떠오르는 곳을 말한다', '서로 편한 중간을 찾는다', false),
    ('7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid, 'one-more', 3, '재밌는 시간이 끝날 무렵 나는?', '재밌는 시간이 끝날 무렵 이 사람은?', '한 곳 더 가자고 한다', '좋을 때 다음을 기약한다', false),
    ('7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid, 'weather-change', 4, '날씨 때문에 계획이 바뀌면 나는?', '날씨 때문에 계획이 바뀌면 이 사람은?', '다른 할 일을 바로 고른다', '그 상황에 맞춰 천천히 바꾼다', false),
    ('7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid, 'unexpected-guest', 5, '예상 못 한 합류자가 생기면 나는?', '예상 못 한 합류자가 생기면 이 사람은?', '더 재밌어질 것 같아 반긴다', '원래 약속의 결을 먼저 본다', false),
    ('7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid, 'late-start', 6, '약속 시간에 늦을 것 같으면 나는?', '약속 시간에 늦을 것 같으면 이 사람은?', '바로 알려 기다릴 시간을 줄인다', '새 도착 시간을 확인해 정확히 알린다', false),
    ('7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid, 'new-place', 7, '처음 보는 장소를 고를 때 나는?', '처음 보는 장소를 고를 때 이 사람은?', '호기심으로 일단 가 본다', '후기와 정보를 먼저 본다', false),
    ('7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid, 'budget', 8, '즉흥 약속의 비용은 나는?', '즉흥 약속의 비용은 이 사람은?', '재밌으면 조금 더 쓸 수 있다', '편한 범위를 먼저 정한다', false),
    ('7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid, 'surprise', 9, '작은 깜짝 계획을 세울 때 나는?', '작은 깜짝 계획을 세울 때 이 사람은?', '완전히 비밀로 준비한다', '힌트를 조금씩 준다', false),
    ('7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid, 'memory-plan', 10, '좋은 즉흥 약속은 내게?', '이 사람에게 좋은 즉흥 약속은?', '예상 못 한 장면이 생긴 날', '서로 편하게 웃은 날', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '7c65607a-7b9b-417a-8f21-5f49c30ab2e2'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('7c65607a-7b9b-417a-8f21-5f49c30ab2e2')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = '7c65607a-7b9b-417a-8f21-5f49c30ab2e2'
...
from (
  values (
    'de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid,
    '9e0d1399-0314-497d-99aa-79926e226726'::uuid,
    'tiny-routine-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid, 'morning-start', 1, '하루를 시작할 때 나는?', '하루를 시작할 때 이 사람은?', '정해 둔 순서가 있어야 편하다', '그날 기분에 따라 시작한다', true),
    ('de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid, 'first-sound', 2, '아침에 가장 먼저 찾는 건?', '이 사람이 아침에 가장 먼저 찾는 건?', '조용한 시간', '음악이나 소리', false),
    ('de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid, 'to-do', 3, '할 일을 기억하는 방식은?', '이 사람이 할 일을 기억하는 방식은?', '적어 두고 지운다', '머릿속 우선순위를 따른다', false),
    ('de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid, 'reset', 4, '흐트러진 하루를 되돌릴 때 나는?', '흐트러진 하루를 되돌릴 때 이 사람은?', '작은 것부터 하나 끝낸다', '잠깐 멈추고 다시 계획한다', false),
    ('de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid, 'walk', 5, '잠깐 바람 쐴 때 나는?', '잠깐 바람 쐴 때 이 사람은?', '목적지를 정하고 걷는다', '발길 가는 대로 걷는다', false),
    ('de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid, 'music', 6, '집중할 때 나는?', '집중할 때 이 사람은?', '늘 듣는 걸 반복한다', '새로운 걸 틀어 분위기를 바꾼다', false),
    ('de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid, 'little-reward', 7, '해야 할 일을 끝내면 나는?', '해야 할 일을 끝내면 이 사람은?', '작은 보상을 챙긴다', '바로 다음 일로 넘어간다', false),
    ('de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid, 'night-close', 8, '하루를 마무리할 때 나는?', '하루를 마무리할 때 이 사람은?', '쓴 물건을 제자리에 둔다', '내일 아침에 한 번에 정리한다', false),
    ('de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid, 'week-reset', 9, '새 주가 시작되기 전 나는?', '새 주가 시작되기 전 이 사람은?', '가방이나 옷부터 챙겨 둔다', '아침에 필요한 것부터 찾는다', false),
    ('de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid, 'broken-routine', 10, '루틴이 깨졌을 때 나는?', '루틴이 깨졌을 때 이 사람은?', '빠르게 원래대로 돌아간다', '새로운 리듬으로 받아들인다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'de2dff48-6ee4-40ec-9efc-555bc083fe63'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('de2dff48-6ee4-40ec-9efc-555bc083fe63')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'de2dff48-6ee4-40ec-9efc-555bc083fe63'
...
from (
  values (
    'b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid,
    '4502a4a8-7ba4-4d3d-9aae-6ca220c57658'::uuid,
    'trip-chemistry-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid, 'packing', 1, '여행 짐을 쌀 때 나는?', '여행 짐을 쌀 때 이 사람은?', '필요한 걸 목록으로 챙긴다', '가방 공간을 보며 감으로 챙긴다', true),
    ('b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid, 'arrival', 2, '도착하자마자 나는?', '도착하자마자 이 사람은?', '짐부터 풀고 동선을 본다', '일단 주변부터 구경한다', false),
    ('b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid, 'map', 3, '길을 찾을 때 나는?', '길을 찾을 때 이 사람은?', '지도와 후기를 미리 본다', '발길 가는 쪽을 따라간다', false),
    ('b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid, 'food', 4, '여행지 식당을 고를 때 나는?', '여행지 식당을 고를 때 이 사람은?', '대표 메뉴부터 먹어 본다', '현지에서 눈에 띈 곳에 들어간다', false),
    ('b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid, 'open-hour', 5, '여행지에서 잠깐 시간이 비면 나는?', '여행지에서 잠깐 시간이 비면 이 사람은?', '가까운 곳을 하나 더 본다', '앉아서 그곳 분위기를 즐긴다', false),
    ('b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid, 'change', 6, '일정이 어그러지면 나는?', '일정이 어그러지면 이 사람은?', '대안을 빠르게 찾는다', '뜻밖의 시간으로 받아들인다', false),
    ('b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid, 'souvenir', 7, '기념품을 고를 때 나는?', '기념품을 고를 때 이 사람은?', '쓸 수 있는 걸 고른다', '그 장소다운 걸 고른다', false),
    ('b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid, 'morning', 8, '여행 중 아침 나는?', '여행 중 아침 이 사람은?', '일찍 시작해 하루를 길게 쓴다', '천천히 일어나 여유를 챙긴다', false),
    ('b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid, 'detour', 9, '가고 싶던 곳이 멀어 보이면 나는?', '가고 싶던 곳이 멀어 보이면 이 사람은?', '그래도 루트를 맞춰 간다', '가까운 즐길 거리를 찾는다', false),
    ('b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid, 'last-night', 10, '여행 마지막 밤 나는?', '여행 마지막 밤 이 사람은?', '다음 날을 위해 정리한다', '마지막까지 밖에서 논다', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'b333cfed-2d11-4da0-acfb-020fe76861ec'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('b333cfed-2d11-4da0-acfb-020fe76861ec')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'b333cfed-2d11-4da0-acfb-020fe76861ec'
...
from (
  values (
    'eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid,
    '2166c7e7-0d4c-411b-bed2-fe3337a2d24c'::uuid,
    'weekend-escape-v2'
  )
) as seed (id, template_id, version)
...
from (
  values
    ('eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid, 'free-morning', 1, '아무 일정 없는 토요일 아침 나는?', '아무 일정 없는 토요일 아침 이 사람은?', '일단 밖으로 나갈 이유를 찾는다', '침대에서 천천히 하루를 연다', true),
    ('eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid, 'last-minute', 2, '주말 약속이 하나 생기면 나는?', '주말 약속이 하나 생기면 이 사람은?', '앞뒤로 다른 계획도 붙인다', '그 약속만 두고 여유를 남긴다', false),
    ('eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid, 'rest-plan', 3, '쉬는 날을 앞두고 나는?', '쉬는 날을 앞두고 이 사람은?', '하고 싶은 걸 미리 적어 둔다', '그날 기분에 맡긴다', false),
    ('eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid, 'home-or-out', 4, '주말 오후에 나는 더 자주?', '주말 오후에 이 사람은 더 자주?', '새로운 동네를 돌아다닌다', '익숙한 곳에서 시간을 보낸다', false),
    ('eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid, 'weather', 5, '날씨가 좋다는 말을 들으면 나는?', '날씨가 좋다는 말을 들으면 이 사람은?', '밖에 나갈 약속을 만든다', '창문 열고 집에서도 즐긴다', false),
    ('eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid, 'late-lunch', 6, '늦은 점심을 고를 때 나는?', '늦은 점심을 고를 때 이 사람은?', '처음 보는 메뉴를 시도한다', '확실히 좋아하는 메뉴를 고른다', false),
    ('eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid, 'one-more-episode', 7, '재밌는 걸 보기 시작하면 나는?', '재밌는 걸 보기 시작하면 이 사람은?', '정한 만큼만 보고 멈춘다', '한 번만 더를 여러 번 한다', false),
    ('eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid, 'sunday-night', 8, '일요일 저녁이 되면 나는?', '일요일 저녁이 되면 이 사람은?', '다음 주 준비를 조금 한다', '마지막까지 주말에 집중한다', false),
    ('eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid, 'mini-adventure', 9, '멀리 못 가는 날 나는?', '멀리 못 가는 날 이 사람은?', '가까운 곳에서 새 코스를 만든다', '집에서 좋아하는 걸 꺼낸다', false),
    ('eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid, 'weekend-proof', 10, '주말이 잘 보냈다고 느끼는 순간은?', '이 사람이 주말을 잘 보냈다고 느끼는 순간은?', '새로운 장면이 생겼을 때', '제대로 쉬었다고 느낄 때', false)
) as seed (
  pack_version_id,
  id,
  position,
...
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'eca8ac2d-6854-4730-9fda-058b020afc8e'
    and version.published_at is null
)
on conflict (pack_version_id, id) do nothing;

select public.publish_pack_version('eca8ac2d-6854-4730-9fda-058b020afc8e')
where exists (
  select 1
  from public.pack_versions as version
  where version.id = 'eca8ac2d-6854-4730-9fda-058b020afc8e'
...
begin
  for v_current in
    ...
    from (
      values
    ('630c20b9-460b-443b-b74b-865d1dfdf5fb'::uuid, 'bc540a1f-611f-4664-b4c7-094fa67f73c0'::uuid),
    ('f16e20a8-f2bd-4799-af68-689bbc36ebd5'::uuid, '550e9a66-9a65-4704-b15a-b6be3f6af644'::uuid),
    ('75ccfdf6-bf0d-4fb8-b8a4-a8cb5f933701'::uuid, '49ee3f96-a2f7-4d05-94ab-26b47d9a5ea8'::uuid),
    ('0a9b7ee3-9556-448f-8719-329094601b1a'::uuid, 'bc3586dc-e21d-463d-b0e8-8480318f86cf'::uuid),
    ('e517cc31-8a8c-4156-a2ae-7e8ddb3f6809'::uuid, 'ef9687d9-12ce-48cb-a130-d7ef63d2e17f'::uuid),
    ('13131313-1313-4313-8313-131313131313'::uuid, '17171717-1717-4717-8717-171717171717'::uuid),
    ('15299196-d3bf-4f89-be1e-bcc1ea69a904'::uuid, '71e68c95-f5f8-478e-81fa-9999168136aa'::uuid),
    ('dec475db-00a1-43ea-91c5-75d32259fd6b'::uuid, 'e0c86bc5-363f-4efa-95e9-1a5672ec3e83'::uuid),
    ('4c3f9b04-48a2-4dda-a2f9-bfcc101a9565'::uuid, 'ce1ce7fe-c839-4d28-8648-462680b96103'::uuid),
    ('12121212-1212-4212-8212-121212121212'::uuid, 'e53a15e2-f710-4945-aa12-839e8ecda934'::uuid),
    ('2cb89681-7c7b-42c4-b1f3-4700d5c17cc0'::uuid, '9afc9717-1059-4e02-89f4-5537d4703919'::uuid),
    ('0e2ac6eb-55f4-40f2-b943-6de54125f6b3'::uuid, '7063c80f-59c4-4f93-8446-205dd8b418bd'::uuid),
    ('14141414-1414-4414-8414-141414141414'::uuid, '9578a970-252f-4eec-a3bf-12f211a56259'::uuid),
    ('f3505753-0118-4778-86fe-19e45d6ec73d'::uuid, '0fbb3eba-ee22-44ed-8a14-fff43f76ad81'::uuid),
    ('11111111-1111-4111-8111-111111111111'::uuid, 'e05e6366-2a00-4798-8273-0af5f16aad10'::uuid),
    ('0fbddb18-d125-429e-ad8f-d6581a3af762'::uuid, 'fee031f8-b347-4f79-a5c7-9d35d8c8804f'::uuid),
    ('a714df85-063e-44f5-a3e5-cc4d6af032bc'::uuid, 'aa2e90e8-0c3f-4eae-9f6f-ec0fb6845697'::uuid),
    ('547524ff-9929-44ef-b6d0-70b152b2f1e2'::uuid, 'a3b94c66-90c7-451b-b4ff-1bd14d7b27bd'::uuid),
    ('79c2f482-e254-41a5-9e27-296bf416a5d7'::uuid, '4a144f35-1f7b-4cb5-a646-7a784c9cd4c3'::uuid),
    ('b5a4e134-2704-40b6-8fa3-7ad47c13e833'::uuid, '403e0aaa-ece5-4c92-88a9-cbe055a819f4'::uuid),
    ('78b2ca60-1f42-4114-a6e0-22155c2d701c'::uuid, '7c65607a-7b9b-417a-8f21-5f49c30ab2e2'::uuid),
    ('9e0d1399-0314-497d-99aa-79926e226726'::uuid, 'de2dff48-6ee4-40ec-9efc-555bc083fe63'::uuid),
    ('4502a4a8-7ba4-4d3d-9aae-6ca220c57658'::uuid, 'b333cfed-2d11-4da0-acfb-020fe76861ec'::uuid),
    ('2166c7e7-0d4c-411b-bed2-fe3337a2d24c'::uuid, 'eca8ac2d-6854-4730-9fda-058b020afc8e'::uuid)
