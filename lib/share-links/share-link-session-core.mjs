...
const RATE_DOMAIN = Buffer.from("gyeop-invite-metadata-v1\0", "utf8");
...
export function deriveInviteRateLimitKey(networkKey, publicId) {
  ...
  if (
    ...
    throw new Error("Invalid invite rate limit scope");
  }
  return createHash("sha256")
    .update(RATE_DOMAIN)
    .update(network)
