...
const PACKS = Object.freeze({
  "after-work": Object.freeze({
    packVersion: "after-work-v1",
    packTitle: "퇴근 후 본캐",
  }),
  "algorithm-mirror": Object.freeze({
    packVersion: "algorithm-mirror-v1",
    packTitle: "알고리즘이 들킨 날",
  }),
  "camera-roll": Object.freeze({
    packVersion: "camera-roll-v1",
    packTitle: "최근 사진 20장",
  }),
  "comment-section": Object.freeze({
    packVersion: "comment-section-v1",
    packTitle: "내적 댓글창",
  }),
  "compliment-receipt": Object.freeze({
    packVersion: "compliment-receipt-v1",
    packTitle: "칭찬 영수증",
  }),
  ...
  "deadline-mode": Object.freeze({
    packVersion: "deadline-mode-v1",
    packTitle: "마감 전의 나",
  }),
  "decision-spiral": Object.freeze({
    packVersion: "decision-spiral-v1",
    packTitle: "결정은 내일의 나에게",
  }),
  "emoji-subtitles": Object.freeze({
    packVersion: "emoji-subtitles-v1",
    packTitle: "이모지 자막 켜기",
  }),
  ...
  "friend-fusion": Object.freeze({
    packVersion: "friend-fusion-v1",
    packTitle: "우리 둘이 섞인다면",
  }),
  "group-chat-role": Object.freeze({
    packVersion: "group-chat-role-v1",
    packTitle: "단톡방의 나",
  }),
  ...
  "laugh-track": Object.freeze({
    packVersion: "laugh-track-v1",
    packTitle: "웃음 버튼의 위치",
  }),
  "reply-temperature": Object.freeze({
    packVersion: "reply-temperature-v1",
    packTitle: "읽고도 생각 중",
  }),
  "room-temperature": Object.freeze({
    packVersion: "room-temperature-v1",
    packTitle: "방 온도와 내 기분",
  }),
  "small-luxury": Object.freeze({
    packVersion: "small-luxury-v1",
    packTitle: "작은 사치 연구소",
  }),
  "snack-personality": Object.freeze({
    packVersion: "snack-personality-v1",
    packTitle: "간식 취향 보고서",
  }),
  "social-battery": Object.freeze({
    packVersion: "social-battery-v1",
    packTitle: "사람들 사이 배터리",
  }),
  "spontaneous-plan": Object.freeze({
    packVersion: "spontaneous-plan-v1",
    packTitle: "갑자기, 지금, 같이?",
  }),
  "tiny-routine": Object.freeze({
    packVersion: "tiny-routine-v1",
    packTitle: "혼자만의 루틴",
  }),
  "trip-chemistry": Object.freeze({
    packVersion: "trip-chemistry-v1",
    packTitle: "여행 가방의 철학",
  }),
  "weekend-escape": Object.freeze({
    packVersion: "weekend-escape-v1",
    packTitle: "주말 사용 설명서",
  }),
});
