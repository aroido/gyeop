...
const CARD_IDS = Object.freeze({
  ...
  "first-impression\0first-impression-v1": Object.freeze([
    "first-move",
    "first-topic",
    "group-entry",
    "silence",
  ...
  "coworker\0coworker-v1": Object.freeze([
    "unclear-task",
    "meeting",
    "focus",
    "deadline",
  ...
  "honest-self\0honest-self-v1": Object.freeze([
    "busy-mind",
    "compliment",
    "big-choice",
    "letdown",
...
export function decodeOwnerProfile(value) {
  ...
  const cardIds = CARD_IDS[`${value.packSlug}\0${value.packVersion}`];
  if (
